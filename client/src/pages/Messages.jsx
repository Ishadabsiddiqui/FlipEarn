        ...
        <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='py-10'>
                ...
                <div className='mb-8'>
                    ...
                    <p className='text-gray-600'>Chat with your buyer and seller</p>
                </div>
                {/* ------------ Search bar ----------- */}
                                ...
                                <button onClick={() => handleOpenChat(chat)} key={chat.id} className='w-full p-4 hover:bg-gray-50 transition-colors text-left'>
                                    <div className='flex items-start space-x-4'>
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            ...
                                            <p className={`text-sm truncate ${!chat.isLastMessageRead && chat.lastMessageSenderId !== user?.id ? "text-indigo-600 font-medium" : "text-gray-500"}`}>{chat.lastMessage || "No Message Yet"}</p>
                                        </div>
                                    </div>
                                </button>
                            )
