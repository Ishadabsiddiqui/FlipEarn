...
import { ArrowLeftIcon, ArrowUpRightFromSquareIcon, Calendar, CheckCircle2, ChevronLeftIcon, ChevronRightIcon, DollarSign, Eye, LineChart, Loader2Icon, MapPin, MessageSquareMoreIcon, ShoppingBagIcon, User2 } from 'lucide-react';
            ...
            <div className='flex items-start max-md:flex-col gap-10'>
                <div className='flex-1 max-md:w-full'>
                            ...
                            <div className='relative w-full aspect-video overflow-hidden'>
                                <div className='flex transition-transform duration-300 ease-in-out' style={{ transform: `translateX(-${current * 100}%)` }}>
                                    {images.map((img, index) => (
                                        <img src={img} key={index} alt="Listing Proof" className='w-full shrink-0' />
                                    ))}
                                </div>
                                {/* --------------Navigation Button -------------- */}
                    ...
                    <div className='bg-white rounded-xl border border-gray-200 mb-5'>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
                            <div>
                                <User2 className='mx-auto text-gray-400 w-5 h-5 mb-1' />
                ...
                <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10'>
                    ...
                    <div className='flex items-center justify-between text-sm text-gray-600 mb-4'>
                        <p className=''>Member Since <span className='font-medium'>{new Date(listing.owner?.createdAt).toLocaleDateString()}</span></p>
                    </div>
