            ...
            <div className='p-5 pt-8'>
                ...
                <div className='flex flex-wrap justify-between max-w-lg items-center gap-3 my-5'>
                    <div className='flex items-center text-sm text-gray-600'>
                        ...
                        <span className='text-lg font-medium text-slate-800 mr-1.5'>{listing.followers_count.toLocaleString()}</span> Folowers
                    </div>
                    {
                ...
                {/* ------------ Description ------------ */}
                <p className='text-sm text-gray-600 mb-4 line-clamp-4'>{listing.description}</p>
